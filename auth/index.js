...
app.config(function ($stateProvider) {
  $stateProvider.state('login', {
    ...
    url: '/signup?referrer',
    templateUrl: 'src/auth/views/signup.html',
    controller: 'SignupController',
    controllerAs: 'vm'
  }).state('password', {
    url: '/password',
    templateUrl: 'src/auth/views/password.html',
    controller: 'PasswordController',
    controllerAs: 'vm',
    authenticate: true
  }).state('forgot', {
    url: '/forgot',
    templateUrl: 'src/auth/views/forgot.html',
    controller: 'ForgotController',
    controllerAs: 'vm'
  }).state('reset', {
    url: '/reset/:token',
    templateUrl: 'src/auth/views/reset.html',
